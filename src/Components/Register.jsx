...
const Register = () => {
    ...
    return (
        <div className='mt-16 mb-20'>
            ...
            <input onChange={handleEmailChange} className='mb-12 w-4/12 rounded ' type="email" placeholder='Your Email Address' required/>
            <br />
            <p className='mr-64'>Password</p>
            <input onBlur={handlepassBlur} className='mb-14 w-4/12 rounded' type="Password" placeholder='Password' required/>
            <br />
            <p className='mr-52'>Confirm Password</p>
            <input className='mb-14 w-4/12 rounded' type="Password" placeholder='Re-Password' />
            <br />
            <p className='mr-64'>Image URL</p>
            <input className='mb-14 w-4/12 rounded' type="text" placeholder='Image Url'required />
            <br />
